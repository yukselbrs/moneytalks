...
// Asama 1-2: Halka (kapora) + Direksiyon (kaldirac). Asama 3: SuBardagi.
// AsansorSVG ve BugdaySVG components/egitim/ortak-svg.tsx'e tasindi — Forward Nedir de kullaniyor.
