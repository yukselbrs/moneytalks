          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 280px", gap: 20, alignItems: "start" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <div style={{ border: "1px solid rgba(59,130,246,0.08)", borderRadius: 12, overflow: "hidden", background: "rgba(255,255,255,0.01)" }}>
                ...
                {HIZLI.map((h, i) => (
                  <div key={h.baslik} onClick={() => { if (i === 0) { setModalTip("fiyat_seviye"); setModalAcik(true); } else if (i === 1) { setModalTip("fiyat_yuzde"); setModalAcik(true); } else if (i === 2) { setModalTip("gosterge"); setModalAcik(true); } else if (i === 3) { setModalTip("bildirim_tercihleri"); setModalAcik(true); } }} style={{ padding: "12px 16px", borderBottom: i < HIZLI.length-1 ? "1px solid rgba(59,130,246,0.04)" : "none", display: "flex", alignItems: "center", gap: 12, cursor: "pointer" }}
