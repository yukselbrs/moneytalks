    ...
    <div style={{ display: "flex", minHeight: "100vh", background: "#060C18", fontFamily: "var(--font-manrope, sans-serif)" }}>
      ...
      <div className="sb-desktop" style={{
        ...
        <div style={{ marginTop: "auto", display: "flex", flexDirection: "column", gap: 2 }}>
          <a href="/profile" className="sb-item" style={{ textDecoration: "none", color: pathname === "/profile" ? "#F8FAFC" : "#64748B", background: pathname === "/profile" ? "rgba(255,255,255,0.06)" : "transparent", marginBottom: 4 }}>
